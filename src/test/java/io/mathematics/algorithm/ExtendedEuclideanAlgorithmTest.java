...
import io.mathematics.modular.ModInt;
...
class ExtendedEuclideanAlgorithmTest {
  ...
  void mulInverse() {
    ...
    assertThatThrownBy(() -> ExtendedEuclideanAlgorithm.mulInv(240, 46)).isInstanceOf(OperationException.class);
    assertThatThrownBy(() -> ExtendedEuclideanAlgorithm.mulInv(22, 30)).isInstanceOf(OperationException.class);
    assertThatThrownBy(() -> ExtendedEuclideanAlgorithm.mulInv(30, 22)).isInstanceOf(OperationException.class);
    ...
    assertThatThrownBy(() -> ExtendedEuclideanAlgorithm.mulInv(240L, 46L)).isInstanceOf(OperationException.class);
    assertThatThrownBy(() -> ExtendedEuclideanAlgorithm.mulInv(22L, 30L)).isInstanceOf(OperationException.class);
    assertThatThrownBy(() -> ExtendedEuclideanAlgorithm.mulInv(30L, 22L)).isInstanceOf(OperationException.class);
