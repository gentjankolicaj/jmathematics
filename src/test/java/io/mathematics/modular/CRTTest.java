...
class CRTTest {
  ...
  void coefficient() {
    ...
    assertThat(CRT.coefficient(new long[]{2, 7, 19}, new long[]{4, 9, 25})).containsAnyOf(225, 100, 576);
  }

  @Test
  void add() {
    assertThat(CRT.add(new long[]{2, 3, 4}, new long[]{1, 2, 1}, new long[]{3, 4, 5})).containsAnyOf(0L, 1L, 0L);
    assertThat(CRT.add(new long[]{2, 3, 4}, new long[]{2, 2, 3}, new long[]{3, 4, 5})).containsAnyOf(1L, 1L, 2L);
  ...
  @Test
  void sub() {
    assertThat(CRT.sub(new long[]{2, 3, 4}, new long[]{1, 2, 1}, new long[]{3, 4, 5})).containsAnyOf(0L, 1L, 0L);
    assertThat(CRT.sub(new long[]{2, 3, 4}, new long[]{2, 2, 3}, new long[]{3, 4, 5})).containsAnyOf(1L, 1L, 2L);
  ...
  @Test
  void mul() {
    assertThat(CRT.mul(new long[]{2, 3, 4}, new long[]{1, 2, 1}, new long[]{3, 4, 5})).containsAnyOf(2L, 2L, 4L);
    assertThat(CRT.mul(new long[]{2, 3, 4}, new long[]{2, 2, 3}, new long[]{3, 4, 5})).containsAnyOf(1L, 2L, 2L);
  ...
  @Test
  void exp() {
    assertThat(CRT.exp(new long[]{2, 3, 4}, new long[]{1, 2, 1}, new long[]{3, 4, 5})).containsAnyOf(2L, 1L, 4L);
    assertThat(CRT.exp(new long[]{2, 3, 4}, new long[]{2, 2, 3}, new long[]{3, 4, 5})).contains(1L, 1L, 4L);
