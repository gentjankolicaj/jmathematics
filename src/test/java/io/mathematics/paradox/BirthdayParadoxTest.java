...
public class BirthdayParadoxTest {
  ...
  void pNoneExp() {
    ...
    assertThat(BirthdayParadox.pNoneExp(23, 365)).isGreaterThanOrEqualTo(BirthdayParadox.pNone(23, 365));
  }
  ...
  void pCollisionExp() {
    ...
    assertThat(BirthdayParadox.pCollisionExp(23, 365)).isLessThanOrEqualTo(BirthdayParadox.pCollision(23, 365));
  }
