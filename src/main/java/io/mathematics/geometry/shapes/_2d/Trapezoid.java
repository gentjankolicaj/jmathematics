package io.mathematics.geometry.shapes._2d;

import io.mathematics.algebra.DetailType;
import io.mathematics.algebra.Point;
...
public class Trapezoid extends Shape2D {
	...
	public Map<DetailType, Object> getDetails() {
		Double[] sideMeasure = {Double.valueOf(side1), Double.valueOf(side2), Double.valueOf(side3), Double.valueOf(side4)};
