...
import io.mathematics.algorithm.Pythagoras;
import io.mathematics.exception.ShapeException;
import io.mathematics.exception.SurfaceAreaException;
import io.mathematics.geometry.shapes._3d.Cone;
import io.mathematics.geometry.shapes._3d.Cube;
import io.mathematics.geometry.shapes._3d.Cuboid;
import io.mathematics.geometry.shapes._3d.Cylinder;
import io.mathematics.geometry.shapes._3d.Ellipsoid;
import io.mathematics.geometry.shapes._3d.Shape3D;
import io.mathematics.geometry.shapes._3d.Sphere;
import io.mathematics.geometry.shapes._3d.SquarePyramid;
	...
	public static double apply(Shape3D t) throws RuntimeException {
		if (t instanceof Cone) {
			...
			if (s.getShapeInfo().equals(ShapeInfo.COMMON_MEASURE)) {
				...
				double slantHeightOfPyramid = Pythagoras.hypotenuse(s.getBaseSideLength() / 2, s.getHeight());
