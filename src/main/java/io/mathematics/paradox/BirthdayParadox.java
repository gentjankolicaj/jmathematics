package io.mathematics.paradox;


import io.mathematics.Paradox;
...
public class BirthdayParadox implements Paradox {
  ...
  /**
   * From <a href="https://en.wikipedia.org/wiki/Pigeonhole_principle">Pigeonhole principle</a> and p(a`)=1-p(a) we find
  ...
  /**
   * From <a href="https://en.wikipedia.org/wiki/Pigeonhole_principle">Pigeonhole principle</a> and p(a`)=1-p(a) using
   * exponential function we find probability of no collision. Using e natural number.
   *
   * @param k number of persons
   * @param d number of days
   * @return probability of no collisions found.
